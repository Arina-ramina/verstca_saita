...
def main():
    ...
    while True:
        ...
        if task == "Стоп":
            ...
            print(db_class.get_companies_and_vacancies_count())
            print()
        elif task == '2':
            print(db_class.get_all_vacancies())
            print()
        elif task == '3':
            print(db_class.get_avg_salary())
            print()
        elif task == '4':
            print(db_class.get_vacancies_with_higher_salary())
            print()
        elif task == '5':
            keyword = input('Введите ключевое слово: ')
            print(db_class.get_vacancies_with_keyword(keyword))
            print()
        else:
